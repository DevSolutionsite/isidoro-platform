...
**Última actualización:** 10 de agosto de 2026 — Fran (migración de subcategorías corrida por Kevin y verificada en vivo, arrancando el frontend del punto 1 de DEC-036, ver DEC-039)
...
- ~~Kevin, bloqueante para el punto 1 de DEC-036 (subcategorías): correr la migración `categories_parent_id`~~ ✅ corrida y verificada en vivo por Fran el 10 de agosto (columna, constraint y FK confirmados con requests reales, ver DEC-039). Frontend de subcategorías (`/admin/categorias`, `/carta`, `ProductForm`) desbloqueado, en curso.
